...
(function () {
  ...
  const I18N = {
    ...
    fr: {
      ...
      'Find a mentoring match': 'Trouver une mise en relation de mentorat',
      'Tell us what you are looking for and we will order the directory for you. Nothing is saved.': 'Dites-nous ce que vous cherchez et nous classerons l’annuaire pour vous. Rien n’est enregistré.',
      'I am looking for': 'Je cherche',
      'a mentor': 'un·e mentor·e',
      'someone to mentor': 'quelqu’un à accompagner',
      'an STSM host': 'un·e hôte STSM',
      'Research theme': 'Thème de recherche',
      'Research region': 'Région de recherche',
      'Your career stage': 'Votre niveau de carrière',
      'Any': 'Indifférent',
      'Doctoral': 'Doctorat',
      ...
      'Ordered with your career stage in mind.': 'Classé en tenant compte de votre niveau de carrière.',
    ...
    de: {
      ...
      'Find a mentoring match': 'Mentoring-Vermittlung finden',
      'Tell us what you are looking for and we will order the directory for you. Nothing is saved.': 'Sagen Sie uns, was Sie suchen, und wir ordnen das Verzeichnis für Sie. Nichts wird gespeichert.',
      'I am looking for': 'Ich suche',
      'a mentor': 'eine·n Mentor·in',
      'someone to mentor': 'jemanden zum Mentoring',
      'an STSM host': 'eine·n STSM-Gastgeber·in',
      'Research theme': 'Forschungsthema',
      'Research region': 'Forschungsregion',
      'Your career stage': 'Ihre Karrierestufe',
      'Any': 'Beliebig',
      'Doctoral': 'Promotion',
      'Early-career': 'Frühe Karriere',
      'Mid-career': 'Mittlere Karriere',
      'Senior': 'Erfahren',
      'Find matches': 'Treffer finden',
      'Ordered with your career stage in mind.': 'Sortiert unter Berücksichtigung Ihrer Karrierestufe.',
