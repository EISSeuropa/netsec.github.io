...
(function () {
  ...
  const I18N = {
    ...
    fr: {
      ...
      'War, military history and armed conflict': 'Guerre, histoire militaire et conflits armés',
      ...
      'Reset the view': 'Réinitialiser la vue',
      // The states that used to say nothing (#1645).
      'Every hub is switched off, so the map is empty.': 'Tous les pôles sont désactivés, la carte est donc vide.',
      'Use All on the filter row to bring it back.': 'Utilisez Tous sur la rangée de filtres pour la rétablir.',
      'The same people are listed on the Working Groups page and the Directory.': 'Les mêmes personnes figurent sur la page Groupes de travail et dans l\u2019annuaire.',
      ...
      // Findings, the things only the map's structure knows (#1646).
      '{a} / {b} share the most people, {n} of them.': '{a} / {b} ont le plus de personnes en commun, {n} au total.',
      '{n} people sit in more than one Working Group.': '{n} personnes appartiennent à plus d\u2019un groupe de travail.',
      '{n} people work on more than one research theme.': '{n} personnes travaillent sur plus d\u2019un thème de recherche.',
      '{name} has the fewest people on the map.': '{name} compte le moins de personnes sur la carte.',
      // Outputs tagged to a Working Group (#1587).
      '{n} output': '{n} publication',
      '{n} outputs': '{n} publications',
      'outputs tagged to a Working Group': 'publications rattachées à un groupe de travail',
      // What the mentorship matcher cannot show, said in words (#1627).
      'Mentorship here starts with an email you send yourself, and an answer is not always quick.': 'Le mentorat commence ici par un courriel que vous envoyez vous-même, et la réponse n\u2019arrive pas toujours vite.',
      'If you are already mentoring as many people as you can take, or you have found your mentor, say so on the {link} and your badge here will follow.': 'Si vous accompagnez déjà autant de personnes que vous le pouvez, ou si vous avez trouvé votre mentor, indiquez-le sur le {link} et votre badge suivra.',
      'directory form': 'formulaire de l\u2019annuaire',
    ...
    de: {
      ...
      'War, military history and armed conflict': 'Krieg, Militärgeschichte und bewaffnete Konflikte',
      ...
      'Every hub is switched off, so the map is empty.': 'Alle Knotenpunkte sind ausgeschaltet, daher ist die Karte leer.',
      'Use All on the filter row to bring it back.': 'Verwenden Sie Alle in der Filterzeile, um sie zurückzuholen.',
      'The same people are listed on the Working Groups page and the Directory.': 'Dieselben Personen stehen auf der Seite Arbeitsgruppen und im Verzeichnis.',
      ...
      '{a} / {b} share the most people, {n} of them.': '{a} / {b} haben die meisten gemeinsamen Personen, insgesamt {n}.',
      '{n} people sit in more than one Working Group.': '{n} Personen gehören mehr als einer Arbeitsgruppe an.',
      '{n} people work on more than one research theme.': '{n} Personen arbeiten an mehr als einem Forschungsthema.',
      '{name} has the fewest people on the map.': '{name} hat die wenigsten Personen auf der Karte.',
      '{n} output': '{n} Veröffentlichung',
      '{n} outputs': '{n} Veröffentlichungen',
      'outputs tagged to a Working Group': 'Veröffentlichungen einer Arbeitsgruppe zugeordnet',
      'Mentorship here starts with an email you send yourself, and an answer is not always quick.': 'Mentoring beginnt hier mit einer E-Mail, die Sie selbst schreiben, und eine Antwort kommt nicht immer schnell.',
      'If you are already mentoring as many people as you can take, or you have found your mentor, say so on the {link} and your badge here will follow.': 'Wenn Sie bereits so viele Personen begleiten, wie Sie können, oder Ihren Mentor gefunden haben, halten Sie das im {link} fest, und Ihr Abzeichen folgt.',
      'directory form': 'Verzeichnisformular',
