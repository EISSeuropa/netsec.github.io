...
(async function () {
  ...
  const I18N = {
    en: {
      ...
      prize: 'European Security Studies Prize',
      prizeAria: 'Winner of the European Security Studies Prize, an EISS and Journal of Strategic Studies initiative for the best paper by an early-career researcher',
    ...
    fr: {
      ...
      prize: 'Prix européen des études de sécurité',
      prizeAria: 'Lauréat du Prix européen des études de sécurité, une initiative de l’EISS et du Journal of Strategic Studies récompensant le meilleur article d’un·e chercheur·euse en début de carrière',
    ...
    de: {
      ...
      prize: 'Europäischer Preis für Sicherheitsstudien',
      prizeAria: 'Ausgezeichnet mit dem Europäischen Preis für Sicherheitsstudien, einer Initiative von EISS und Journal of Strategic Studies für die beste Arbeit einer Nachwuchsforscherin oder eines Nachwuchsforschers',
