...
|---|---|---|---|---|---|---|
| L1 | 0 / link-check | `licensing.{en,fr,de}.html` | **P0** | `commission.europa.eu/communication/visual-identity-and-branding_en` → 404. The EU Commission shuffled the URL for the visual-identity guidance. | Find the current EC URL for the visual-identity manual (or replace with the IIIO archive copy) and update the three locale variants. | fixed in [PR #246](https://github.com/EISSeuropa/netsec.github.io/pull/246); the page now links the current EC visual-identity URL |
| L2 | 0 / link-check | `privacy.{en,fr,de}.html` | **P0** | `commission.europa.eu/law/law-topic/data-protection/international-dimension-data-protection/eu-us-data-privacy-framework_en` → 404. | Same — find the current EU Commission page for the EU-US Data Privacy Framework. | fixed in [PR #246](https://github.com/EISSeuropa/netsec.github.io/pull/246) |
| L3 | 0 / link-check | `privacy.{en,fr,de}.html` | **P0** | `formspree.io/legal/privacy-policy` → 404. Formspree moved their policies. | Update to the current Formspree privacy-policy URL (at the time of writing, probably under `formspree.io/legal/` or `help.formspree.io/`). | fixed June 2026: Formspree now 301-redirects the old URL; the pages link the canonical trailing-slash URL directly |
| L4 | 0 / link-check | `faq.{en,fr,de}.html` | **P0** | `www.cost.eu/uploads/2025/06/COST-Annotated-Rules.pdf` → 404. Placeholder URL guessed at the time the FAQ was written. | Verify the canonical COST URL for the Annotated Rules, or remove the link if it's not yet published. | fixed in [PR #246](https://github.com/EISSeuropa/netsec.github.io/pull/246) |
| L5 | 0 / link-check | `glossary.{en,fr,de}.html` | **P0** | `www.cost.eu/uploads/2025/04/MoU-063-25.pdf` → 404. Same placeholder pattern as L4. | Verify with Grant Holder / COST office whether a public MoU URL exists; replace or remove. | fixed in [PR #246](https://github.com/EISSeuropa/netsec.github.io/pull/246) |
