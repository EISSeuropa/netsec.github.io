...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **24 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.13.0** (5 Added, 4 Changed, 15 Fixed). Last refresh by `scripts/sync-roadmap.py`: 22 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
