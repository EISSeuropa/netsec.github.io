...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **38 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.11.0** (15 Added, 10 Changed, 13 Fixed). Last refresh by `scripts/sync-roadmap.py`: 12 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
