...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **26 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.12.0** (1 Added, 14 Changed, 11 Fixed). Last refresh by `scripts/sync-roadmap.py`: 22 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
