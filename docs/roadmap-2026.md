...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **12 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.13.0** (3 Added, 2 Changed, 7 Fixed). Last refresh by `scripts/sync-roadmap.py`: 8 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
