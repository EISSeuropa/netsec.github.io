...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **23 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.14.0** (3 Added, 4 Changed, 16 Fixed). Last refresh by `scripts/sync-roadmap.py`: 15 Sep 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
