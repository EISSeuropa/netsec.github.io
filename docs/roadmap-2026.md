...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **15 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.13.0** (3 Added, 3 Changed, 9 Fixed). Last refresh by `scripts/sync-roadmap.py`: 18 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
...
| 8 Dec 2026 | 📅 **v1.15.0** | The parking bay for work this repo cannot start on its own. The visa-letter signatory and the Indico document-generation template, which cannot begin before September 2026 ([#374](https://github.com/EISSeuropa/netsec.github.io/issues/374)) · deliverable ship-status on the About page, once the Action confirms it ([#447](https://github.com/EISSeuropa/netsec.github.io/issues/447)) · the Indico push pipeline, which waits on the `netsec-dispatch` plugin being deployed on the Indico instance ([#823](https://github.com/EISSeuropa/netsec.github.io/issues/823), moved out of v1.14.0) · the inaugural MC plenary date and the ledger audit behind it ([#1491](https://github.com/EISSeuropa/netsec.github.io/issues/1491)). The date is provisional and moves with whichever confirmation arrives first. |
