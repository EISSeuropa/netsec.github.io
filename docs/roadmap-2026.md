...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **50 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.10.0** (12 Added, 20 Changed, 18 Fixed). Last refresh by `scripts/sync-roadmap.py`: 7 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
