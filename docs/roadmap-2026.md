...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **8 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.10.0** (1 Added, 4 Changed, 3 Fixed). Last refresh by `scripts/sync-roadmap.py`: 1 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
