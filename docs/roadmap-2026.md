...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **74 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.12.0** (27 Added, 24 Changed, 22 Fixed, 1 Removed). Last refresh by `scripts/sync-roadmap.py`: 22 Jul 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
