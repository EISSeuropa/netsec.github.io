...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **25 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.11.0** (10 Added, 8 Changed, 7 Fixed). Last refresh by `scripts/sync-roadmap.py`: 10 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
