...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **61 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.11.0** (18 Added, 22 Changed, 21 Fixed). Last refresh by `scripts/sync-roadmap.py`: 16 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
