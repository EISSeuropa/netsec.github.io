...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **5 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.13.0** (3 Added, 1 Changed, 1 Fixed). Last refresh by `scripts/sync-roadmap.py`: 28 Jul 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
