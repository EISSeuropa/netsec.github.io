...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **45 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.11.0** (17 Added, 11 Changed, 17 Fixed). Last refresh by `scripts/sync-roadmap.py`: 12 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
