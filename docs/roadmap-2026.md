...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **20 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.12.0** (2 Added, 2 Changed, 16 Fixed). Last refresh by `scripts/sync-roadmap.py`: 29 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
