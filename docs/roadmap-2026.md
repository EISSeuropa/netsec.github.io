...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **67 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.11.0** (17 Added, 27 Changed, 23 Fixed). Last refresh by `scripts/sync-roadmap.py`: 17 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
