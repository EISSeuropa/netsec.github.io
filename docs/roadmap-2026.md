...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **28 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.10.0** (11 Added, 11 Changed, 6 Fixed). Last refresh by `scripts/sync-roadmap.py`: 4 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
