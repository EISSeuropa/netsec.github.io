...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **43 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.14.0** (6 Added, 11 Changed, 26 Fixed). Last refresh by `scripts/sync-roadmap.py`: 26 Sep 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
