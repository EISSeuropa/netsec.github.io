...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **2 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.10.0** (1 Added, 1 Changed). Last refresh by `scripts/sync-roadmap.py`: 31 May 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
