...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **14 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.10.0** (4 Added, 6 Changed, 4 Fixed). Last refresh by `scripts/sync-roadmap.py`: 3 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
