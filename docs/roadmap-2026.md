...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **1 entry** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.9.0** (1 Changed). Last refresh by `scripts/sync-roadmap.py`: 29 May 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
