...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **25 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.12.0** (1 Added, 13 Changed, 11 Fixed). Last refresh by `scripts/sync-roadmap.py`: 21 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
