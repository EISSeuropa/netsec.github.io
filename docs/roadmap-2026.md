...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **31 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.11.0** (11 Added, 10 Changed, 10 Fixed). Last refresh by `scripts/sync-roadmap.py`: 10 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
