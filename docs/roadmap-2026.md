...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **26 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.9.0** (13 Added, 8 Changed, 5 Fixed). Last refresh by `scripts/sync-roadmap.py`: 30 May 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
