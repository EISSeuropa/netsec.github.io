...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **5 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.12.0** (1 Added, 2 Changed, 2 Fixed). Last refresh by `scripts/sync-roadmap.py`: 18 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
