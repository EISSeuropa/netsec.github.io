...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **12 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.9.0** (8 Added, 4 Changed). Last refresh by `scripts/sync-roadmap.py`: 30 May 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
