...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **20 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.10.0** (7 Added, 7 Changed, 6 Fixed). Last refresh by `scripts/sync-roadmap.py`: 3 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
