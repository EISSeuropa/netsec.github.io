...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **17 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.8.1** (5 Added, 8 Fixed, 4 Changed). Last refresh by `scripts/sync-roadmap.py`: 28 May 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
