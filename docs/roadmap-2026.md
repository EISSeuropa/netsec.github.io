...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **14 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.12.0** (1 Added, 7 Changed, 6 Fixed). Last refresh by `scripts/sync-roadmap.py`: 20 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
