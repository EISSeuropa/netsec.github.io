...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **38 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.13.0** (12 Added, 9 Changed, 17 Fixed). Last refresh by `scripts/sync-roadmap.py`: 27 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
