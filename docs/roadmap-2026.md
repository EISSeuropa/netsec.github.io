...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **48 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.11.0** (17 Added, 13 Changed, 18 Fixed). Last refresh by `scripts/sync-roadmap.py`: 13 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
