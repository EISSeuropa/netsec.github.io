...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **35 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.11.0** (13 Added, 10 Changed, 12 Fixed). Last refresh by `scripts/sync-roadmap.py`: 11 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
