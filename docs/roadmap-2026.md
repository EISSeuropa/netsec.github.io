...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **14 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.11.0** (7 Added, 4 Changed, 3 Fixed). Last refresh by `scripts/sync-roadmap.py`: 9 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
