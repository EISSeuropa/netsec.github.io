...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **62 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.13.0** (21 Added, 16 Changed, 25 Fixed). Last refresh by `scripts/sync-roadmap.py`: 29 Aug 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
