...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **14 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.14.0** (1 Added, 2 Changed, 11 Fixed). Last refresh by `scripts/sync-roadmap.py`: 5 Sep 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
