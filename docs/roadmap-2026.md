...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **33 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.14.0** (5 Added, 9 Changed, 19 Fixed). Last refresh by `scripts/sync-roadmap.py`: 24 Sep 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
