...
| Early Sep 2026 | 📅 *was-v1.8.0 deferred scope* | Per-event `.ics` + Add-to-calendar buttons on event cards · news RSS feed at `/news.xml` · D10 (risk management strategy) hosted. Re-version separately. |
