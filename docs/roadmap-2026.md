...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **57 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.10.0** (12 Added, 20 Changed, 25 Fixed). Last refresh by `scripts/sync-roadmap.py`: 8 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
