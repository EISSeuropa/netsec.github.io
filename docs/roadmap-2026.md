...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **10 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.11.0** (5 Added, 3 Changed, 2 Fixed). Last refresh by `scripts/sync-roadmap.py`: 8 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
