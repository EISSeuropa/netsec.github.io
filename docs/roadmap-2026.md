...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **1 entry** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.12.0** (1 Added). Last refresh by `scripts/sync-roadmap.py`: 17 Jun 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
