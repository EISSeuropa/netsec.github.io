...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **6 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.13.0** (3 Added, 1 Changed, 2 Fixed). Last refresh by `scripts/sync-roadmap.py`: 29 Jul 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
