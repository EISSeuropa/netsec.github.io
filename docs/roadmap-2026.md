...
<!-- AUTOSTAMP:BEGIN -->
> _Auto-tracked: **32 entries** in [`[Unreleased]`](../CHANGELOG.md#unreleased) since **v1.12.0** (7 Added, 2 Changed, 22 Fixed, 1 Removed). Last refresh by `scripts/sync-roadmap.py`: 17 Jul 2026. Prose in the timeline below may lag; the maintainer resynthesises on release-time §5 sweep._
<!-- AUTOSTAMP:END -->
