/* @ds-bundle: {"format":3,"namespace":"NetSecDesignSystem_948961","components":[{"name":"Button","sourcePath":"components/buttons/Button.jsx"},{"name":"MemberCard","sourcePath":"components/directory/MemberCard.jsx"},{"name":"FilterChip","sourcePath":"components/forms/FilterChip.jsx"},{"name":"Input","sourcePath":"components/forms/Input.jsx"},{"name":"Badge","sourcePath":"components/labels/Badge.jsx"},{"name":"Chip","sourcePath":"components/labels/Chip.jsx"},{"name":"Eyebrow","sourcePath":"components/labels/Eyebrow.jsx"},{"name":"WGChip","sourcePath":"components/labels/WGChip.jsx"},{"name":"Avatar","sourcePath":"components/media/Avatar.jsx"},{"name":"GlassCard","sourcePath":"components/surfaces/GlassCard.jsx"}],"sourceHashes":{"components/buttons/Button.jsx":"10de42dd5611","components/directory/MemberCard.jsx":"7e1135f9f217","components/forms/FilterChip.jsx":"2ce52345ecd5","components/forms/Input.jsx":"f358bbb93b55","components/labels/Badge.jsx":"ae6c1edfc2ab","components/labels/Chip.jsx":"88ab6a319e8c","components/labels/Eyebrow.jsx":"9c59be69e858","components/labels/WGChip.jsx":"ae92aa2eaf50","components/media/Avatar.jsx":"82ecbfe5defd","components/surfaces/GlassCard.jsx":"0e945ad1827f","slides/deck-stage.js":"208980974db4","ui_kits/website/Chrome.jsx":"57e68484ecda","ui_kits/website/Directory.jsx":"2c19f1fbb85f","ui_kits/website/Home.jsx":"77fc523d9dbd","ui_kits/website/data.js":"2d8001db2e5e"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.NetSecDesignSystem_948961 = window.NetSecDesignSystem_948961 || {});
...
/**
 * NetSec button. Primary = filled ink, hover → accent + glow.
 * Ghost = transparent glass with border, hover → slight lift.
...
function Button({
  ...
  const pad = size === "sm" ? "9px 16px" : size === "lg" ? "16px 28px" : "13px 22px";
  const fs = size === "sm" ? ".88rem" : size === "lg" ? "1.02rem" : ".95rem";
  const base = {
    display: "inline-flex",
    alignItems: "center",
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Filter chip / segmented toggle button used in the directory toolbar.
 * `active` fills it (ink, or a WG colour when `wg` is set); idle is glass.
 */
function FilterChip({
  children,
  active = false,
  ...
  const activeBg = wg ? `var(--wg-${wg})` : "var(--ink)";
  const base = {
    display: "inline-flex",
    alignItems: "center",
    gap: "7px",
    ...
    backdropFilter: "var(--blur-chip)",
    WebkitBackdropFilter: "var(--blur-chip)",
    border: active ? `1px solid ${activeBg}` : "1px solid var(--glass-border)",
    ...style
  };
  return /*#__PURE__*/React.createElement("button", _extends({
    type: "button",
    ...
    style: {
      ...
      height: 8,
      borderRadius: "50%",
      background: active ? "#fff" : wg ? `var(--wg-${wg})` : "var(--accent-2)"
    }
  }) : null, children);
}
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Text / search input. Glass-ish fill, hairline border, accent focus ring.
 * Pass `icon` for a leading glyph (e.g. a search magnifier).
 */
function Input({
  icon,
  type = "text",
  ...
  const wrap = {
    ...
    borderColor: focus ? "var(--accent-2)" : "var(--line)",
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Small status/tag label. `tag` = uppercase outlined tag inside grant
 * cards. `founding` = quiet outlined "Founding contributor" pill with a
 * star glyph. `solid` = filled accent tag.
 */
function Badge({
  children,
  variant = "tag",
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    style: base
  }, rest), variant === "founding" && !icon ? /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
      color: "var(--accent-2)"
    }
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Neutral keyword pill — glass fill, hairline border, fully rounded.
 * Used for hero keywords and generic tags.
 */
function Chip({
  children,
  style,
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Small uppercase letter-spaced label above an h1/h2. Conveys section
 * context without competing for hierarchy. On conference slides it
 * takes the monospace `pill` form with a leading dot.
 */
function Eyebrow({
  children,
  variant = "plain",
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    style: merged
  }, rest), variant === "pill" ? /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
      marginRight: ".5em"
    }
...
// components/labels/WGChip.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Working-Group chip — small bright solid pill colour-coded WG1–WG4.
 * Shown on member cards to mark group membership.
 */
function WGChip({
  wg = 1,
  children,
...
Object.assign(__ds_scope, { WGChip });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/labels/WGChip.jsx", error: String((e && e.message) || e) }); }

// components/media/Avatar.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Member avatar — either a headshot image or a monogram initials disc.
 * Monograms use a soft tinted fill (accent by default, or a WG colour).
 */
function Avatar({
  name = "",
  src,
  ...
  const initials = name.split(/\s+/).filter(Boolean).filter(w => !/^(dr|prof|mr|mrs|ms|mx)\.?$/i.test(w)).slice(0, 2).map(w => w[0]?.toUpperCase()).join("");
  const ring = wg ? `var(--wg-${wg})` : "var(--accent-2)";
  const base = {
    width: size,
    height: size,
    borderRadius: "50%",
    ...
    fontSize: size * 0.34,
    color: ring,
    background: wg ? `color-mix(in oklab, var(--wg-${wg}) 18%, #fff)` : "color-mix(in oklab, var(--accent-2) 16%, #fff)",
    border: "1px solid var(--glass-border)",
    ...style
  };
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * The workhorse glass card — semi-transparent fill, backdrop blur,
 * soft shadow, and (optionally) a 4px lift on hover. Almost every
 * distinct piece of information on the site is a .glass card.
 */
function GlassCard({
  children,
  as = "article",
  ...
  const base = {
    ...
    boxShadow: lift ? "var(--shadow-lg)" : "var(--glass-shadow)",
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Directory member card — avatar, name, role, affiliation (with flag),
 * Working-Group chips and an optional "Founding contributor" badge.
 * Composes Avatar + WGChip + Badge inside a hoverable GlassCard.
 */
function MemberCard({
  name,
  role,
  ...
  return /*#__PURE__*/React.createElement(__ds_scope.GlassCard, _extends({
  ...
  }, role) : null, affiliation ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: "6px",
    ...
    "aria-hidden": "true"
  }, flag) : null, /*#__PURE__*/React.createElement("span", null, affiliation)) : null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: "6px",
      flexWrap: "wrap",
  ...
  }, wgs.map(w => /*#__PURE__*/React.createElement(__ds_scope.WGChip, {
    key: w,
    wg: w
  }))), founding ? /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: "10px"
    }
  }, /*#__PURE__*/React.createElement(__ds_scope.Badge, {
    variant: "founding"
  }, "Founding contributor")) : null));
}
Object.assign(__ds_scope, { MemberCard });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/directory/MemberCard.jsx", error: String((e && e.message) || e) }); }
...
try { (() => {
// NetSec website — shared chrome: ambience background + floating glass nav.
const {
  Button
} = window.NetSecDesignSystem_948961;
function Ambience() {
  return /*#__PURE__*/React.createElement("div", {
    "aria-hidden": "true",
    style: {
    ...
    style: {
      position: "absolute",
      inset: 0,
      backgroundImage: "linear-gradient(rgba(11,18,32,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(11,18,32,.035) 1px,transparent 1px)",
...
function Nav({
  ...
  const link = active => ({
    ...
    cursor: "pointer",
    whiteSpace: "nowrap",
    background: active ? "rgba(11,18,32,.05)" : "transparent",
  ...
  return /*#__PURE__*/React.createElement("nav", {
    ...
    src: "../../assets/images/brand/netsec-lockup-primary-nav.png",
    alt: "NetSec",
    style: {
      height: 30,
      width: "auto"
...
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
// NetSec website — searchable people directory.
const {
  Eyebrow,
  Input,
  FilterChip,
...
function Directory() {
  const people = window.NETSEC_PEOPLE;
  const [q, setQ] = React.useState("");
  const [wg, setWg] = React.useState(0); // 0 = All

  const filtered = people.filter(p => {
    const matchWg = wg === 0 || p.wgs.includes(wg);
    const hay = `${p.name} ${p.role} ${p.affiliation}`.toLowerCase();
    const matchQ = q.trim() === "" || hay.includes(q.toLowerCase());
    return matchWg && matchQ;
  });
  const countries = new Set(people.map(p => p.flag)).size;
  return /*#__PURE__*/React.createElement("main", {
    ...
    variant: "pill"
  }, "The Network \xB7 Open Directory"), /*#__PURE__*/React.createElement("h1", {
    style: {
  ...
  }, "A directory you can ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--accent-2)"
    }
  }, "actually search")), /*#__PURE__*/React.createElement("p", {
    style: {
      maxWidth: "52ch",
      margin: "0 auto",
      color: "var(--ink-2)",
  ...
  }, "Filter ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: "var(--ink)"
    }
  }, people.length, " members"), " across ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: "var(--ink)"
    }
  }, countries, " countries"), " by working group, role and country \u2014 combined, instantly.")), /*#__PURE__*/React.createElement(GlassCard, {
    strong: true,
    padding: "18px",
    style: {
      marginBottom: 24
    ...
    dot: true,
    onClick: () => setWg(0)
  }, "All"), [1, 2, 3, 4].map(n => /*#__PURE__*/React.createElement(FilterChip, {
    key: n,
    wg: n,
    dot: true,
    active: wg === n,
    onClick: () => setWg(n)
  }, "WG ", n))), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: "var(--font-mono)",
      fontSize: ".78rem",
      color: "var(--muted)"
    }
  }, filtered.length, " of ", people.length, " members"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(auto-fill,minmax(330px,1fr))",
      gap: 16
    }
  }, filtered.map(p => /*#__PURE__*/React.createElement(MemberCard, _extends({
    key: p.name
  }, p)))), filtered.length === 0 ? /*#__PURE__*/React.createElement("p", {
    style: {
      textAlign: "center",
      color: "var(--muted)",
      padding: "48px 0"
    }
  }, "No members match those filters.") : null);
}
...
function Home({
  ...
  return /*#__PURE__*/React.createElement("main", {
    ...
    variant: "pill"
  }, "COST Action \xB7 European Cooperation in Science & Technology")), /*#__PURE__*/React.createElement("h1", {
    style: {
      margin: "0 auto 22px",
      maxWidth: "16ch",
      fontFamily: "var(--font-display)",
  ...
  }, "Networking ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--accent-2)"
    }
  }, "European security"), " knowledge"), /*#__PURE__*/React.createElement("p", {
    style: {
      maxWidth: "60ch",
      margin: "0 auto",
  ...
  }, "An inclusive, multidisciplinary network ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: "var(--ink)"
    }
  }, "bridging the academia\u2013policy divide"), " and cultivating the next generation of European security scholars."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 12,
      justifyContent: "center",
    ...
    variant: "primary"
  }, "Discover the Action"), /*#__PURE__*/React.createElement(Button, {
    variant: "ghost",
    onClick: () => setView("directory")
  }, "Explore the directory")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 10,
      justifyContent: "center",
  ...
  }, window.NETSEC_KEYWORDS.map(k => /*#__PURE__*/React.createElement(Chip, {
    key: k
    ...
    src: "../../assets/images/cost-logo.jpg",
    alt: "COST",
    style: {
      height: 34,
      width: "auto",
  ...
  }, "Funded by", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", {
    style: {
      color: "var(--ink-2)"
    }
  }, "the European Union"))));
...
try { (() => {
// NetSec website UI kit — sample directory data (a subset of the real roster).
window.NETSEC_PEOPLE = [{
  name: "Dr Arthur Laudrain",
  role: "Communications Lead",
  affiliation: "ETH Zürich",
  flag: "🇨🇭",
  photo: "../../assets/images/people/arthur-laudrain.webp",
  wgs: [1, 3],
  founding: true
}, {
  name: "Dr Marie Robin",
  role: "Action Vice-Chair · Grant Holder",
  ...
  flag: "🇫🇷",
  photo: "../../assets/images/people/chiara-ruffa.webp",
  wgs: [3],
  founding: true
}, {
  name: "Dr Moritz Weiss",
  role: "Action Chair · WG1 Leader",
  affiliation: "LMU Munich",
  flag: "🇩🇪",
  wgs: [1],
  founding: true
}, {
  name: "Dr Revecca Pedi",
  role: "WG4 Leader",
  ...
  role: "Grant Awarding Coordinator",
  affiliation: "Bilkent University",
  flag: "🇹🇷",
  photo: "../../assets/images/people/eliza-gheorghe.webp",
  wgs: [2],
  founding: true
}, {
  name: "Mr Eugenio Sánchez",
  role: "Science Communication",
  affiliation: "Sciences Po Paris",
  flag: "🇫🇷",
  photo: "../../assets/images/people/eugenio-sanchez.webp",
  wgs: [3],
  founding: true
}, {
  name: "Dr Anna Pagnacco",
  role: "Early-Career Representative",
  affiliation: "University of Trento",
  flag: "🇮🇹",
  photo: "../../assets/images/people/anna-pagnacco.webp",
  wgs: [2, 4]
}, {
  ...
  flag: "🇨🇦",
  photo: "../../assets/images/people/alexander-lanoszka.webp",
  wgs: [2]
}, {
  name: "Mr Archishman Goswami",
  role: "PhD Researcher",
  affiliation: "King's College London",
  flag: "🇬🇧",
  photo: "../../assets/images/people/archishman-goswami.webp",
  wgs: [1, 3]
}, {
  name: "Ms Alisa Kerschbaum",
  role: "Summer School Fellow",
  affiliation: "University of Vienna",
  flag: "🇦🇹",
  photo: "../../assets/images/people/alisa-kerschbaum.webp",
  wgs: [4]
}];
window.NETSEC_NAV = ["News", "About", "Working Groups", "Network", "Events", "Grants", "Publications"];
window.NETSEC_KEYWORDS = ["Security Studies", "European Defence", "Strategic Autonomy", "Policy Impact"];
...
__ds_ns.WGChip = __ds_scope.WGChip;
