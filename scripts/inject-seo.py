...
PAGES = ["index", "people", "grants", "accessibility", "privacy", "licensing", "press-kit", "faq", "glossary", "about", "outputs", "news", "roadmap", "sitemap"]
...
# "article" — that's the closest match in the Open Graph vocabulary
# for a single-topic content page.
OG_TYPES = {
    "index": "website",
    "people": "website",
    "grants": "website",
